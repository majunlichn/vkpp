...
// https://www.jcgt.org/published/0009/03/02/#:~:text=We%20evaluate%20a%20range%20of%20existing%20hash%20functions%20for%20random
// https://www.shadertoy.com/view/XlGcRh

// commonly used constants
#define HASH_C1 0xcc9e2d51u
#define HASH_C2 0x1b873593u
...
#define HASH_A0 0x67452301u
#define HASH_B0 0xefcdab89u
#define HASH_C0 0x98badcfeu
#define HASH_D0 0x10325476u
...
uvec4 md5(uvec4 u)
{
    uvec4 digest = uvec4(HASH_A0, HASH_B0, HASH_C0, HASH_D0);
    uvec4 r, v = digest;
    uint i = 0u;
