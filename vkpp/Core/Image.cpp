...
rad::Ref<ImageView> Image::CreateImageView(
    ...
    const VkComponentMapping* componentMapping)
{
    ...
    return RAD_NEW ImageView(m_device, this, createInfo);
}

rad::Ref<ImageView> Image::CreateImageView2D(
...
rad::Ref<ImageView> Image::CreateDefaultView()
{
    ...
    wholeRange.aspectMask = GetImageAspectFromFormat(m_format);
